...
class BersihJalan extends StatefulWidget {
  @override
  _BersihJalanPageState createState() => new _BersihJalanPageState();
}



class _BersihJalanPageState  extends State<BersihJalan> {

  String _luaslahan, _jenislayanan, _alamat;
  String _ordername = "Bersih Jalan", _user = "Exca";
  int _price = 50000;
